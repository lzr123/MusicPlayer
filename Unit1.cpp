        ...
        : TForm(Owner)
{
    ...
    SpeedButton4->Glyph->LoadFromFile("D:\\KM\\delete_icon.bmp");
      ...
      TScrollCode ScrollCode, int &ScrollPos)
{
      ...
      if (MediaPlayer1->FileName != "")
      {
            ...
            SpeedButton1->Glyph->LoadFromFile("D:\\KM\\play_icon.bmp");
...
void __fastcall TForm1::loadMusicAndPlay(AnsiString fileloc)
{
	if (fileloc != "")
    {
         ...
         SpeedButton1->Glyph->LoadFromFile("D:\\KM\\pause_icon.bmp");
    }
...
void __fastcall TForm1::SpeedButton4Click(TObject *Sender)
{
    ...
    {
    	Label5->Caption = "Click item to delate";
        SpeedButton4->Glyph->LoadFromFile("D:\\KM\\delete_act_icon.bmp");
    }
    else
    {
    	Label5->Caption = "";
...
{
	mode = sequencial;
    SpeedButton6->Glyph->LoadFromFile("D:\\KM\\seq_play_act_icon.bmp");
    SpeedButton7->Glyph->LoadFromFile("D:\\KM\\single_play_icon.bmp");
    SpeedButton8->Glyph->LoadFromFile("D:\\KM\\random_play_icon.bmp");
}
//---------------------------------------------------------------------------
...
{
 	mode = single;
    SpeedButton6->Glyph->LoadFromFile("D:\\KM\\seq_play_icon.bmp");
    SpeedButton7->Glyph->LoadFromFile("D:\\KM\\single_play_act_icon.bmp");
    SpeedButton8->Glyph->LoadFromFile("D:\\KM\\random_play_icon.bmp");
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::SpeedButton8Click(TObject *Sender)
{
    ...
    SpeedButton6->Glyph->LoadFromFile("D:\\KM\\seq_play_icon.bmp");
    SpeedButton7->Glyph->LoadFromFile("D:\\KM\\single_play_icon.bmp");
    SpeedButton8->Glyph->LoadFromFile("D:\\KM\\random_play_act_icon.bmp");
}
//---------------------------------------------------------------------------
